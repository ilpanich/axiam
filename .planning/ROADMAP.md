...
- [ ] 25-07-PLAN.md — SECHRD-08: per-tenant HKDF AMQP signing (mandatory, no fail-open) + cross-tenant/unsigned tests
...
| 25. Security Hardening II — Federation/PKI/Data/Infra | 3/10 | In Progress|  |
