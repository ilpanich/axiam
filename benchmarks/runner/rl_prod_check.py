...
ENDPOINTS = {
    "login_per_min": (
        ...
        # The three /api/v1/auth/opaque/* endpoints share this bucket: all are
        # unauthenticated, both take a user identifier, and neither carries a
        # client identity to key on. `opaque_login_start.js` drives the start
        ...
        "POST /api/v1/auth/login (also covers /api/v1/auth/opaque/*)",
    ),
