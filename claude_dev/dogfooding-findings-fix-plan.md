...
| C-4 | Java | `ilpanich/axiam-java-sdk` | `feat/contract-1.51` | [#102](https://github.com/ilpanich/axiam-java-sdk/pull/102) | open, CI green (`678d310`) | `webhooks` in the manifest |
