...
| C-6 | PHP | `ilpanich/axiam-php-sdk` | `feat/contract-1.51` | [#73](https://github.com/ilpanich/axiam-php-sdk/pull/73) | open | `users`/`scopes` manifest entities (flat tier, §7.2); `webhooks` in the manifest |
...
| C-8 | Kotlin | `ilpanich/axiam-kotlin-sdk` | `feat/contract-1.51` | [#68](https://github.com/ilpanich/axiam-kotlin-sdk/pull/68) | open | no gRPC transport (so §1.1.1/§10.3 wrappers); Ktor-engine mTLS evidence wiring; `webhooks` in the manifest |
