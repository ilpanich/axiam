...
| C-2 | TypeScript | `ilpanich/axiam-typescript-sdk` | `feat/contract-1.51` | [#116](https://github.com/ilpanich/axiam-typescript-sdk/pull/116) | open | `webhooks` in the manifest; §6.1 rule 7 as a typestate (the client-side branch instead) |
