...
| C-5 | C# | `ilpanich/axiam-csharp-sdk` | `feat/contract-1.51` | [#95](https://github.com/ilpanich/axiam-csharp-sdk/pull/95) | open | `webhooks` in the manifest; §6.1 rule 7 as a typestate (the client-side branch instead) |
