...
| 3 | C-10 | C | `ilpanich/axiam-c-sdk` | `feat/contract-1.51` | pushed `4cc3216` (64 ctest, 98.1 %/84.4 %; both row-17 defects fixed; device login real); sent back: SSO/federation completions don't reset the §5.2 gate; Q5 mislabelled as Rust's | | | |
