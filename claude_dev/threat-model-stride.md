...
14 of 280 threats remain open, and one of them is new and is a different kind from the other thirteen. T-272, T-275, T-276 and T-280 arrived with Phase 21 from [`security-review-mcp-2026-09-17.md`](security-review-mcp-2026-09-17.md) and **do** sit on AXIAM's own request path: they are filed defects with named fixes rather than trade-offs, and they were open because each needed a settings field, a migration or a change to a handler its own task did not touch. Three of the four — T-272, T-275 and T-276 — closed on 2026-09-17 and are recorded below; **T-280 alone is still open** here, fail-closed, and is an interoperability defect rather than a vulnerability. When it closes this paragraph goes with it, because its whole point was that the group existed. The other thirteen are unchanged: none of them is an unhandled defect in AXIAM's own request path: they are accepted design trade-offs, responsibilities that land on whoever deploys AXIAM, or gaps on the SDK and distribution side. The one entry that did sit on the request path, T-254's refresh-rotation grace window, was closed by the maintainer's decision of 2026-09-12 and is no longer listed here; the two that sat on the token service and on the SDK guard since the first version of this model, T-39 and T-143, closed together on 2026-09-13 when the revocation feed gained a poller in every SDK, and are recorded under *Closed at 1.0.0-beta14* below. They are listed most severe first.
...
**Closed at the 2026-09-17 T21.8 remediation** — recorded rather than deleted, as with T-145. Three of Phase 21's four filed defects, decided and costed in [`issues-469-472-fix-plan.md`](issues-469-472-fix-plan.md); the fourth, T-280, is on its own pull request and is still listed above.
