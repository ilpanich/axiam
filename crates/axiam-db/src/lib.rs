...
pub use repository::{
    SurrealAuditLogRepository, SurrealCaCertificateRepository, SurrealGroupRepository,
    ...
    SurrealSessionRepository, SurrealTenantRepository, SurrealUserRepository, hash_client_secret,
    verify_password,
};
