...
- **Plan id**: `lXNwmKhhAKlgv`
- **Modules**: 37
- **Passed**: 30/37

**7 module(s) did not pass.** A submission built on this run would be a submission with 7 open question(s).
...
| `REVIEW` | 6 | the suite cannot decide automatically — a human must read the log and judge |
...
|---|---|---|
| `fapi2-security-profile-final-test-claims-parameter-identity-claims` | `WARNING` | `1aprleiRVeeIqZJ` |
| `fapi2-security-profile-final-ensure-authorization-request-with-long-state` | `REVIEW` | `2HOh59lKouIsxyq` |
| `fapi2-security-profile-final-ensure-unsigned-authorization-request-without-using-par-fails` | `REVIEW` | `mQ6XQtgV7MC8QfB` |
| `fapi2-security-profile-final-par-ensure-reused-request-uri-prior-to-auth-completion-succeeds` | `REVIEW` | `vzy0oVaynr9nnel` |
| `fapi2-security-profile-final-par-attempt-reuse-request_uri` | `REVIEW` | `r2V4mCrDRokwuMW` |
| `fapi2-security-profile-final-par-attempt-to-use-expired-request_uri` | `REVIEW` | `rOof0Ntmkk9uSsM` |
| `fapi2-security-profile-final-par-attempt-to-use-request_uri-for-different-client` | `REVIEW` | `gg7mzzMsvd3e5cI` |
