...
|---|---|---|
| `oidcc-prompt-login` | `REVIEW` | `HqW61KWtkTynPan` |
| `oidcc-max-age-1` | `REVIEW` | `JlLF4Y1sCO5U2kA` |
| `oidcc-ensure-registered-redirect-uri` | `REVIEW` | `KslW7yWosTsUOda` |
| `oidcc-ensure-request-object-with-redirect-uri` | `REVIEW` | `ChosCSgDZp0Kx6z` |
