var __dsPreview = (() => {
  ...
  // .design-sync/previews/UserSearchDialog.tsx
  var UserSearchDialog_exports = {};
  __export(UserSearchDialog_exports, {
    AssignRoleWithExisting: () => AssignRoleWithExisting,
    EmptySearchPrompt: () => EmptySearchPrompt,
  ...
  var CSRF_METHODS = /* @__PURE__ */ new Set(["post", "put", "patch", "delete"]);
  ...
  api.interceptors.response.use(
    ...
    async (error) => {
      ...
      const isAuthenticated = ds_exports.useAuthStore.getState().isAuthenticated;
      if (error.response?.status === 401 && !originalRequest._retry && !isSkipRefresh && isAuthenticated) {
        ...
        try {
          ...
          queryClient.clear();
          ds_exports.useAuthStore.getState().clearAuth();
  ...
  function mapUserFromApi(u) {
    ...
    return {
      ...u,
      display_name: typeof displayName === "string" ? displayName : void 0
    };
  }
  var userService = {
    /**
    ...
    list: (page = 1, perPage = 20, search = "") => {
      ...
      return api_default.get(
        `/api/v1/users?${params.toString()}`
      ).then((r2) => {
        const mapped = {
          ...r2.data,
          items: r2.data.items.map(mapUserFromApi)
        };
        const term = search.trim().toLowerCase();
        if (!term) return mapped;
        const items = mapped.items.filter(
          (u) => u.username.toLowerCase().includes(term) || u.email.toLowerCase().includes(term) || (u.display_name?.toLowerCase().includes(term) ?? false)
        );
        return { ...mapped, items };
      });
    },
    get: (userId) => api_default.get(`/api/v1/users/${userId}`).then((r2) => mapUserFromApi(r2.data)),
    create: (payload) => {
      ...
      return api_default.post("/api/v1/users", body).then((r2) => mapUserFromApi(r2.data));
    },
    update: (userId, payload) => {
      const { display_name, ...rest } = payload;
      const body = {
        ...rest,
        ...display_name !== void 0 ? { metadata: { display_name } } : {}
      };
      return api_default.put(`/api/v1/users/${userId}`, body).then((r2) => mapUserFromApi(r2.data));
    },
    remove: (userId) => api_default.delete(`/api/v1/users/${userId}`).then(() => void 0),
    listMfaMethods: (userId) => api_default.get(`/api/v1/users/${userId}/mfa-methods`).then((r2) => unwrapList(r2.data)),
    deleteMfaMethod: (userId, methodId) => api_default.delete(`/api/v1/users/${userId}/mfa-methods/${methodId}`).then(() => void 0),
    resetMfa: (userId) => api_default.post(`/api/v1/users/${userId}/reset-mfa`).then(() => void 0),
    unlock: (userId) => api_default.post(`/api/v1/users/${userId}/unlock`).then((r2) => mapUserFromApi(r2.data))
  };
  ...
  var buttonVariants = cva(
    "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
    {
      variants: {
        variant: {
          default: "bg-primary text-primary-foreground hover:shadow-glow-cyan hover:-translate-y-0.5",
          destructive: "bg-destructive text-destructive-foreground hover:opacity-90",
          outline: "border border-primary/30 bg-transparent text-primary hover:bg-primary/10 hover:border-primary hover:shadow-glow-cyan",
          secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80",
          ghost: "text-muted-foreground hover:bg-white/5 hover:text-foreground",
          link: "text-primary underline-offset-4 hover:underline",
          accent: "bg-accent text-accent-foreground hover:shadow-glow-purple hover:-translate-y-0.5"
        },
        size: {
  ...
  function UserSearchDialog({
    ...
    const [actingId, setActingId] = (0, import_react4.useState)(null);
    const { data, isFetching } = (0, ds_exports.useQuery)({
    ...
    async function handleAction(user2) {
      setActingId(user2.id);
      try {
        await onAction(user2);
      } catch {
      } finally {
        setActingId(null);
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "relative z-10 glass-card w-full max-w-md flex flex-col max-h-[80vh]", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center justify-between pb-4 border-b border-primary/10", children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                "h2",
                {
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "py-4 flex flex-col gap-3 overflow-hidden", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "overflow-y-auto flex-1 min-h-[120px] max-h-60 rounded-md border border-white/5", children: isFetching ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex items-center justify-center py-6", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LoaderCircle, { size: 20, className: "animate-spin text-primary/60" }) }) : searchTerm.length < 2 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-sm text-muted-foreground text-center py-6", children: "Type at least 2 characters to search." }) : results.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-sm text-muted-foreground text-center py-6", children: "No users found." }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ul", { children: results.map((user2) => {
                const alreadyExists = existingIds?.has(user2.id) ?? false;
                return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                  "li",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-sm font-medium text-foreground/90", children: user2.display_name ?? user2.username }),
                        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs text-muted-foreground", children: user2.email })
                      ] }),
                      alreadyExists ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs text-muted-foreground", children: existingLabel }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
                        "button",
                        {
                          onClick: () => void handleAction(user2),
                          disabled: actingId === user2.id,
                          ...
                          children: [
                            actingId === user2.id ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LoaderCircle, { size: 12, className: "animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Plus, { size: 12 }),
                            actionLabel
                          ]
                        }
                      )
            ...
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex justify-end pt-4 border-t border-primary/10", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { variant: "ghost", onClick: handleClose, children: "Done" }) })
          ] })
        ]
      }
    );
  ...
  function user(id, username, email, display_name) {
    return {
      id,
      username,
      email,
  ...
  function TypeSearch({ term }) {
    ...
    (0, import_react5.useEffect)(() => {
      const input = ref.current?.closest("[data-stage]")?.querySelector('input[type="search"]');
      if (!input) return;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { ref, hidden: true });
  }
  var noop2 = () => {
  };
  var noAction = async () => {
  ...
  function Dialog({
    ...
    const client = (0, import_react5.useRef)();
    if (!client.current) {
      client.current = new ds_exports.QueryClient({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Stage, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { "data-stage": true, style: { position: "absolute", inset: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(ds_exports.QueryClientProvider, { client: client.current, children: [
      ...
      term ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TypeSearch, { term }) : null
    ] }) }) });
  }
  function EmptySearchPrompt() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Dialog, { title: "Add members to platform-operators", actionLabel: "Add" });
  }
  ...
  function AssignRoleWithExisting() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Dialog,
      {
        ...
        existingIds: /* @__PURE__ */ new Set(["u_01J8", "u_03P9"]),
        term: "acme",
        seeded: [
          user("u_01J8", "m.rossi", "m.rossi@acme-prod.example", "Marta Rossi"),
  ...
  return __toCommonJS(UserSearchDialog_exports);
})();
