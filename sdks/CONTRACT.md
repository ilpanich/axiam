...
| R-29 | A stated `inherit: true` was refused (Java). `inherit: false` without a resource was sent (C++, TypeScript) | Java, C++, TypeScript | §27.6.1 | **contract fixed** and **SDK fixed** | N6.2 · Java #103, C++ #68, TypeScript #119 |
