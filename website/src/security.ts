      ...
      },
      {
        ...
        rows: [
          ...
          [
            ...
            "Tenant context derived from the verified session or JWT — never from request input — and enforced on every query and graph traversal; cross-tenant reach only as an explicit organization-scope claim, verified to stay inside the caller's organization",
          ],
          [
            "AXIAM ↔ third parties",
