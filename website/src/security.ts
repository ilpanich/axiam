      ...
      },
      {
        ...
        rows: [
          [
            ...
            "TLS 1.3 — terminated by the server itself on the documented topology — authentication, rate limiting keyed on a peer address derived by a stated rule, CSRF on cookie requests, input validation; forwarded headers (`X-Forwarded-For`, `X-Client-Certificate`) trusted only from a proxy the deployment runs",
          ],
          [
            "AXIAM ↔ data tier",
