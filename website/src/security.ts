...
export const SEC_SECTIONS: SecSection[] = [
  ...
  /* ---- Posture & practice ------------------------------------------------ */
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          [
            ...
            "All tracked MUSTs pass; 165 suite modules, zero `FAILED` on 2026-09-11 — a self-run against a working-tree build, not a certification; `REVIEW` and `WARNING` verdicts are published, not counted as passes",
      ...
      {
        type: "p",
        text: "Dependency and supply-chain security is gated in CI — `cargo audit`, `cargo deny`, Trivy filesystem/config scans and `npm audit` at a high threshold, with Dependabot across the workspace's ecosystems and each SDK repository, SHA-pinned GitHub Actions, and signed release provenance — and the gate tells a registry outage apart from a clean audit and fails on a suppression that no longer matches anything, so it cannot quietly be told what to ignore.",
      },
    ],
  },
