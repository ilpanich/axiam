...
export const THREAT_MODEL_SUMMARY: ThreatModelSummary = {
 ...
 "openRisks": [
  ...
  },
  {
   ...
   "residualRisk": "Partially addressed: audit metadata is deliberately minimised and erasure anonymises the subject rather than deleting audit records. Deployments must set an audit retention period consistent with their lawful basis; AXIAM does not enforce one today."
  },
  {
   "number": 118,
